									...
									<div class="card-body">
										...
										<form action="UpdateCategory" method="post">
											<div class="row mb-3">
												...
												<div class="col-sm-3">
													<input hidden="hidden" type="text" id="id" name="Id" value="${categoryView.id}">
												</div>
											</div>
											<div class="row mb-3">
												<label class="col-sm-2 col-form-label">Name:</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id="Name" placeholder="Enter name" name="Name" value="${categoryView.name}">
												</div>
											</div>
											<div class="row mb-3">
												<label class="col-sm-2 col-form-label">Created At:</label>
												<div class="col-sm-3">
													<input readonly type="text" class="form-control" id="date" placeholder="Enter name" name="Created_At" value="${categoryView.created_At}">
												</div>
											</div>
											...
											<div class="row mb-3">
												...
												<div class="col-sm-3">
													<textarea id="Content" name="Content" rows="4" cols="50" >${categoryView.content}</textarea>
												</div>
											</div>
