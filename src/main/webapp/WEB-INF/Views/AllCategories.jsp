...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../../../Images/blog_logo.png" class="d-block w-100" alt="..." height="350px">
        </div>
...
<section class="bg-light py-4 my-5" style="background-color: white">
    <div class="container" >
        <div class="row">
            <c:forEach items="${cats_list}" var="category">
                <div class="col-md-6 col-lg-4">
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="#" class="text-secondary">${category.name}</a></h3>
