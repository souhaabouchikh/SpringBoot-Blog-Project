    ...
    <section class="py-5">
      <div class="container">
        <div class="row gy-5">
          <!-- Latest Posts -->
          <main class="col-lg-8"> 
            <div class="container"><img class="img-fluid w-100 mb-4" src="../../../img/blog-post-3.jpeg" alt="...">
              ...
              <h1 class="mb-4">Diversity in Engineering: The Effect on Questions<a href="!#"><i class="fa fa-bookmark-o"></i></a></h1>
              <ul class="list-inline list-separated text-gray-500 mb-5">
                <li class="list-inline-item"><a class="d-flex align-items-center flex-wrap text-reset" href="!#">
                    <div class="avatar flex-shrink-0"><img class="img-fluid" src="../../../img/avatar-1.jpg" alt="..."></div><small>John Doe</small></a></li>
