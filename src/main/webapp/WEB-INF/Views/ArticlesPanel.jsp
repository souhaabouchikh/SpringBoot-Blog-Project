							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="customers.html" class="current-page">Customers</a>
										</li>
										<li>
